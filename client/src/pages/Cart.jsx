...
useEffect(() => {
    const total = cartData.reduce((acc, cart) => acc + cart.total, 0);
    ...
    const subTotalToSet = couponApplied ? total - 20 : total;
    ...
    <div className="cart-page-container">
        ...
        {cartData.length<1?(
            <div className="no-cartitems">
                ...
                <img src="https://cdn-icons-png.flaticon.com/512/11010/11010851.png" className="cart-img" alt="cart"/>
